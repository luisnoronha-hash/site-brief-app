      ...
      <>
        ...
        <main className="container-content flex min-h-[60vh] items-center justify-center">
          <div className="max-w-md text-center">
            <h1 className="font-serif text-2xl text-navy">Check your inbox</h1>
            <p className="mt-4 text-sm text-navy-600">
              We&rsquo;ve sent a confirmation link to <strong>{email}</strong>. Verify your email to
              complete your broker profile and submit your first order.
            </p>
          </div>
        </main>
      </>
